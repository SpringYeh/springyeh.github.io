            ...
            return i(e, [{
                ...
                value: function(e) {
                    ...
                    try {
                        ...
                        t.nodata = {
                            show: function(e) {
                                s.innerHTML = e || t.i18n.no_comment_yet,
                        ...
                        t.nodata.show();
                        var g = t.el.querySelector(".vsmile-icons")
                          , m = e.emoticon_list || [];
                        for (var b in m) {
                            var y = document.createElement("img");
                            y.setAttribute("src", e.emoticon_url + "/" + m[b]),
                            g.appendChild(y)
                        }
                        p || (n.init({
                        ...
                        var x = "https://github.com/DesertsP/Valine/issues";
                        return void (t.el ? t.nodata.show('<pre style="color:red;text-align:left;">' + e + "<br>Valine:<b>" + t.version + "</b><br>feedback：" + x + "</pre>") : console && console.log("%c" + e + "\n%cValine%c" + t.version + " " + x, "color:red;", "background:#000;padding:5px;line-height:30px;color:#fff;", "background:#456;line-height:30px;padding:5px;color:#fff;"))
                    }
                    var w = '<div class="spinner"><div class="r1"></div><div class="r2"></div><div class="r3"></div><div class="r4"></div><div class="r5"></div></div>'
                      , k = t.el.querySelector(".vloading");
                    k.innerHTML = w,
                    t.loading = {
                        show: function() {
                    ...
                    var A = t.el.querySelector(".vsubmitting");
                    A.innerHTML = w,
                    t.submitting = {
                        show: function() {
                    ...
                    var S = t.el.querySelector(".vmark");
                    t.alert = {
                        show: function(e) {
                            S.innerHTML = '<div class="valert txt-center"><div class="vtext">' + e.text + '</div><div class="vbtns"></div></div>';
                            var n = S.querySelector(".vbtns")
                            ...
                            S.querySelector(".vcancel").addEventListener("click", function(e) {
                                t.alert.hide()
                            }),
                            S.setAttribute("style", "display:block;"),
                            e && e.type) {
                                var o = S.querySelector(".vsure");
                    ...
                    t.loading.show();
                    var _ = new t.v.Query("Comment");
                    _.equalTo("url", u.url);
                    var z = new t.v.Query("Comment");
                    z.equalTo("url", u.url + "/");
                    var T = AV.Query.or(_, z);
                ...
                value: function(e) {
                    ...
                    var S = t.el.querySelector(".vsubmit")
                      ...
                      , T = t.el.querySelector(".vsmile-icons");
                    v.on("click", z, function(e) {
                        L.getAttribute("triggered") && (L.setAttribute("style", "display:none;"),
                        L.removeAttribute("triggered")),
                        T.getAttribute("triggered") ? (T.setAttribute("style", "display:none;"),
                        T.removeAttribute("triggered")) : (T.removeAttribute("style"),
                        T.setAttribute("triggered", 1))
                    });
                    var C = t.el.querySelector(".vpreview-btn")
                      , L = t.el.querySelector(".vpreview-text");
                    v.on("click", C, function(t) {
                        if (T.getAttribute("triggered") && (T.setAttribute("style", "display:none;"),
                        T.removeAttribute("triggered")),
